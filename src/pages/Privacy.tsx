      ...
      <main className="max-w-3xl mx-auto">
        ...
        >
          <section>
            ...
            <p className="mb-4">
              At PickColors, we respect your privacy and are committed to protecting your personal data. This privacy policy will inform you as to how we look after your personal data when you visit our website and tell you about your privacy rights and how the law protects you.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-4">
              ...
              <br /><br />
              <a href="mailto:privacy@pickcolors.com" className="text-primary hover:underline">privacy@pickcolors.com</a>
            </p>
          </section>
        </motion.div>
      </main>
